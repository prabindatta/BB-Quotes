...
struct FetchController {
    ...
    func fetchQuote(from show: String) async throws -> Quote {
        ...
        let quoteQueryItem = URLQueryItem(name: "production", 
                                          value: show.replaceSpaceWithPlus)
    ...
    func fetchCharacter(_ name: String) async throws -> Character {
        ...
        let characterQueryItem = URLQueryItem(name: "name",
                                              value: name.replaceSpaceWithPlus)
